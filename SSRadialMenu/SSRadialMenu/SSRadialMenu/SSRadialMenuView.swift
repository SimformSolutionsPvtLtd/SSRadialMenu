...
struct SSRadialMenu: View {
    ...
    /// Creates a radial menu with customisation options
    ...
    /// Animation and interaction state for menu levels, It groups all the animation and interaction state variables for each menu level (main, sub, sub-sub) into a single, organised structure instead of having scattered individual @State variables.
...
// MARK: - MenuCard Component - Optimised card view builder
extension SSRadialMenu {
...
// MARK: - Menu Level Helper Functions - Optimised helper functions with consolidated accessors
extension SSRadialMenu {
