...
// MARK: - Centralised Constants for Performance Optimisation
struct Constants {
    ...
    struct AnimationConstants {
        ...
        static let itemSequenceDelay: Double = 0.35
        static let springAnimationResponse: Double = 0.8
        static let springAnimationDamping: Double = 0.8
        static let fadeInDuration: Double = 0.3
        static let fadeOutDuration: Double = 0.25
        static let momentumDuration: Double = 1.8
        static let momentumUpdateDelay: Double = 0.12

        // Spin wheel momentum constants for smooth, controlled behavior
        static let momentumFrameRate: Double = 1.0 / 60.0
        static let momentumSmoothness: Double = 0.28
        static let momentumDecayRate: Double = 0.970
        static let momentumMinimumVelocity: Double = 0.10
    }
    ...
    struct PerformanceConstants {
        ...
        static let momentumVelocityMultiplier: Double = 0.035
        static let maximumMomentumVelocity: Double = 8.0
        static let flickVelocityThreshold: CGFloat = 250.0
    }
}
